...
function App() {
  ...
  const info = [
    ...
    {title: "รายงานการจองอุปกรณ์", content: "ตารางแสดงข้อมูลการจองอุปกรณ์ผ่านระบบ ITem Support ของนักศึกษาเเละบุคลากรภายในคณะ สามารถจัดการคำสั่งจอง และตรวจสอบประวัติและสถานะการสั่งจองได้ของไอเทมเเต่ละชิ้นได้", path: "reservation"},
    {title: "รายงานการยืมคืนอุปกรณ์", content: "ตารางแสดงข้อมูลการยืมคืนอุปกรณ์ทั้งหมดของนักศึกษาและบุคลากรภายในคณะ สำหรับจัดการสถานะของอุปกรณ์ รวมถึงตรวจสอบประวัติการยืมเเละคืนอุปกรณ์ของเเต่ละบุคคล", path: "history"}
  ]
  const { id } = useParams();
