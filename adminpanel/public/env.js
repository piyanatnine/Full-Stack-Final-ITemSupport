window.env = {
  ...
  "npm_package_description": "## How To set up Project  - ``` cd adminpanel && npm install  ```  - create .env file (you can follow set up by the example in ```.env.example``` file in directory)  - ``` npm start ```",
